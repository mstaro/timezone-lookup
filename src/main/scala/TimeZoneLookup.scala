...
import org.geotools.data.collection.{ListFeatureCollection, SpatialIndexFeatureCollection}
...
object TimeZoneLookup {
  //  private val geocodeInputStream = getClass.getResourceAsStream("/geocodes/US.txt")
...
//  private val tzSource = DataUtilities.source(new SpatialIndexFeatureCollection(featureSource.getFeatures))
